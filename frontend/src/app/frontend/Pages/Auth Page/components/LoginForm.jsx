...
export default function LoginForm({ isAdmin = false }) {
  ...
  return (
    <form onSubmit={onSubmit} className="space-y-5">
      <div>
        ...
        <div className="mt-1 relative">
          ...
          <input
            ...
            autoComplete="email"
            required
            defaultValue={isAdmin ? 'admin@gmail.com' : ''}
            readOnly={isAdmin}
      ...
      <button type="submit" className="w-full rounded-lg bg-gradient-to-r from-blue-600 to-indigo-600 text-white px-4 py-2.5 font-semibold shadow hover:from-blue-700 hover:to-indigo-700 focus:outline-none focus:ring-2 focus:ring-blue-500">Login</button>
    </form>
  )
}
